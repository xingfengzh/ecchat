...
module.exports = function (orgName, appName, clientId, clientSecret, accessToken) {
	 ...
	 * @return {void}
	 */
	this.api.createUser = function (username, password, nickname, callback) {
   ...
   * @return {void}
   */
  this.api.resetPassword = function (username, newPassword, callback) {
	 ...
	 * @return {void}
	 */
	this.api.getChatRecord = function (time, callback) {
		return this.getToken(function () {
